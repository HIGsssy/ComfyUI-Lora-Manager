...
export class AnimaLoraContextMenu extends BaseContextMenu {
    constructor() {
        super('animaLoraContextMenu', '.model-card');
        this.nsfwSelector = document.getElementById('nsfwLevelSelector');
        this.modelType = 'anima_loras';
    ...
    handleMenuAction(action) {
        ...
        // Otherwise handle Anima LoRA-specific actions
        switch (action) {
            case 'details':
...
Object.assign(AnimaLoraContextMenu.prototype, ModelContextMenuMixin);
